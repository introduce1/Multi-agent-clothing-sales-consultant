...
一个基于多智能体架构的现代化客服系统，支持智能对话、订单处理、知识库管理等功能。
...
│   ├── reception_agent.py  # 接待智能体（意图识别和路由）
│   ├── sales_agent.py     # 销售智能体
│   ├── order_agent.py     # 订单处理智能体
│   ├── knowledge_agent.py # 知识智能体
│   ├── styling_agent.py   # 搭配智能体
│   ├── agent_dispatcher.py # 智能体调度器
│   └── smart_collaboration.py # 智能协作系统
├── api/                   # API接口层
│   ├── routers/          # 路由模块
│   │   ├── chat.py       # 对话接口
│   │   ├── agents.py     # 智能体管理
...
│   └── product_search_service.py # 产品搜索服务
├── utils/                # 工具模块
│   ├── logger.py         # 日志工具
